  ...
  if (!isOpen) {
    return (
      <button
        ...
        className="fixed bottom-6 right-6 z-50 w-16 h-16 bg-[#ff6b4d] text-white rounded-full shadow-2xl hover:shadow-[#ff6b4d]/40 hover:scale-110 transition-all duration-300 flex items-center justify-center group"
      >
