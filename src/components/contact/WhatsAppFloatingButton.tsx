 ...
 * Simple floating button that opens WhatsApp with a pre-filled message
 * Separate from Butler AI - this is for direct WhatsApp contact
 */

export const WhatsAppFloatingButton = () => {
  const handleWhatsAppClick = () => {
    // WhatsApp phone number - update this with your actual number
    const phoneNumber = '971501234567'; // Format: country code + number (no + or spaces)
