...
const HBSHeroSection = () => {
  ...
  return (
    <section className="relative w-full text-white pt-24 pb-16 px-4 md:px-8 lg:px-12 min-h-screen flex flex-col justify-end overflow-hidden font-sans">
      ...
      {/* Container */}
      <div className="max-w-[1600px] mx-auto w-full relative z-10 flex flex-col items-start text-left pt-48 pb-24 px-8 md:px-12 lg:px-16">
        <div className="ml-0 md:ml-[calc(40px+3rem)] lg:ml-[calc(40px+4rem)] xl:ml-[calc(40px+6rem)]">
          {/* Main Headline */}
          <h1 className="text-[40px] leading-[48px] font-semibold tracking-tight mb-8 max-w-6xl">
            Every Skill You Need to Succeed in the<br />New Digital Economy
          </h1>
          {/* Paragraph */}
          <p className="text-[18px] leading-[28px] font-normal max-w-3xl text-white/90">
