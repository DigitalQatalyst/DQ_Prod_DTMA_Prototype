...
export const Module2Resource = () => {
  ...
  const articleText = `
    Perfect Life Transactions - The Cornerstone of Economy 4.0
    
    Perfection isn't a goal—it's the new baseline. In a world where every transaction is a test of brand credibility, 
    the stakes for delivering seamless, error-free experiences have never been higher.
    
    Foreword. In the evolving digital economy, competitive advantage increasingly hinges on the quality of transactional experiences. 
    As markets shift towards real-time, personalized engagement, organizations must rethink how value is delivered—not just through 
    products or services, but through every seamless, intelligent, and trust-based interaction.
    
    Executive Summary. The future of economic leadership lies in mastering seamless, intelligent, and value-driven transactions. 
    In Economy 4.0, success depends not just on products or services but on orchestrating Perfect Life Transactions.
    
    Understanding Perfect Life Transactions. Digital Qatalyst perceives Perfect Life Transactions as the gold standard of digital 
    interactions, characterized by seamless, intuitive, and hyper-personalized experiences that eliminate inefficiencies while 
    maximizing customer satisfaction and business value.
    
    Enablers of Perfect Transactions. Achieving Perfect Life Transactions requires a combination of cutting-edge technology, 
    real-time intelligence, and seamless digital infrastructure. Organizations must adopt a proactive approach to transaction optimization.
    
    Implementing Perfect Transactions. Organizational Readiness requires a customer-centric culture where leadership and frontline 
    staff are aligned in delivering exceptional digital experiences.
    
    The Growth Hack Model. Perfect Life Transactions are not static—they require continuous optimization and refinement through 
    structured phases from Market to Lead to Revenue to Loyalty.
    
    Conclusion. As Economy 4.0 redefines business success, Perfect Life Transactions emerge as the key differentiator for 
    organizations aiming to stay competitive in an increasingly digital landscape.
  `;
  ...
  const simulateAIResponse = (userMessage: string): string => {
    ...
    if (lowerMessage.includes('summarize') || lowerMessage.includes('summary')) {
      if (lowerMessage.includes('foreword')) {
        return "The Foreword explains that competitive advantage in the digital economy increasingly depends on the quality of transactional experiences. Organizations must rethink value delivery through seamless, intelligent, and trust-based interactions. This whitepaper introduces Perfect Life Transactions as a key differentiator in Economy 4.0, drawing on Transaction Cost Economics and Behavioral Economics to reframe transactions as strategic assets.";
      } else if (lowerMessage.includes('perfect life') || lowerMessage.includes('transaction')) {
        return "Perfect Life Transactions are the gold standard of digital interactions—seamless, intuitive, and hyper-personalized experiences that eliminate inefficiencies while maximizing customer satisfaction. Key pillars include: Efficiency (instantaneous transactions), Accuracy (error elimination), Personalization (data-driven customization), Transparency (full visibility), and Security (trust through encryption and fraud detection).";
      } else if (lowerMessage.includes('enabler')) {
        return "Three key enablers of Perfect Life Transactions: 1) Unified Digital Business Platforms (DBPs) that orchestrate data, AI, and automation; 2) Advanced AI-Driven Systems with predictive analytics and self-learning capabilities; 3) Real-Time Data Analytics that enable continuously optimized experiences. These work together to create intelligent, adaptive transactional ecosystems.";
      } else {
        return "This whitepaper discusses Perfect Life Transactions as the cornerstone of Economy 4.0. Key topics include: understanding what makes transactions 'perfect', the technological enablers (DBPs, AI, analytics), organizational readiness requirements, and the Growth Hack Model for continuous optimization. The main message: transactions are strategic assets that drive loyalty, efficiency, and growth.";
      }
    }
    
    // Explanation requests
    if (lowerMessage.includes('explain') || lowerMessage.includes('what is') || lowerMessage.includes('what are')) {
      if (lowerMessage.includes('perfect life transaction')) {
        return "Perfect Life Transactions are seamless, intuitive, and hyper-personalized digital interactions that eliminate inefficiencies while maximizing customer satisfaction and business value. They integrate behavioral economics and digital automation to ensure decision-making is intuitive, efficient, and data-driven. Think of it as Jeff Bezos' philosophy: treating customers as invited guests to a party where every interaction is effortless and memorable.";
      } else if (lowerMessage.includes('dbp') || lowerMessage.includes('digital business platform')) {
        return "Unified Digital Business Platforms (DBPs) are the core infrastructure that orchestrates data, AI, and automation to deliver smart, fluid, and connected experiences. They centralize transaction management, eliminate inefficiencies, break down organizational silos, and ensure consistency across all customer touchpoints. DBPs enhance transactional efficiency by streamlining coordination and reducing uncertainty.";
      } else if (lowerMessage.includes('growth hack')) {
        return "The Growth Hack Model is a structured, data-driven approach to transaction optimization with six phases: Market to Lead (M2L), Lead to Opportunity (L2O), Opportunity to Order (O2O), Order to Fulfillment (O2F), Fulfillment to Revenue (F2R), and Revenue to Loyalty (R2L). Each phase uses AI, automation, and analytics to continuously refine and scale Perfect Life Transactions.";
      } else if (lowerMessage.includes('behavioral economics')) {
        return "Behavioral Economics in this context emphasizes creating ease, trust, and predictability in digital interactions. It recognizes that human behavior is influenced by psychological factors beyond pure rationality. Perfect Life Transactions leverage these insights to reduce cognitive effort, minimize friction, and guide users toward intuitive decisions.";
      }
    }
    
    // Key points requests
    if (lowerMessage.includes('key point') || lowerMessage.includes('important') || lowerMessage.includes('takeaway')) {
      return "Key takeaways from this whitepaper:\n\n1. Perfect Life Transactions are strategic assets, not just operational steps\n2. Five pillars: Efficiency, Accuracy, Personalization, Transparency, Security\n3. Three enablers: DBPs, AI-driven systems, real-time analytics\n4. Organizational readiness requires customer-centric culture and change management\n5. Growth Hack Model provides structured optimization from M2L to R2L\n6. Transactions drive loyalty, efficiency, and competitive advantage in Economy 4.0";
    }
    
    // Default helpful response
    return "I'm here to help you understand Perfect Life Transactions! You can ask me to:\n\n• Summarize any section (e.g., 'Summarize the enablers')\n• Explain concepts (e.g., 'What are DBPs?')\n• Clarify the Growth Hack Model\n• Identify key points and takeaways\n• Generate notes for you\n\nWhat would you like to know?";
  };
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-[#1e2348] text-[20px] leading-[28px] font-bold">
              Module 2 Resource: Perfect Life Transactions
            </h3>
            <p className="text-[#4B5563] text-[14px] leading-[20px]">
              VOLUME 1 | Digital Economy 4.0 : WP#2 (DE & Perfect Life Transactions)
            </p>
          </div>
        ...
        >
          ...
          <section className="mb-12">
            ...
            <div className="bg-gray-50 p-4 rounded-lg mb-4">
              <p className="font-semibold text-gray-900">Dr. Stephane Niango</p>
              <p className="text-sm text-gray-600">Chief Architect | D6 Framework Creator</p>
              <p className="text-sm text-gray-600">DigitalQatalyst</p>
            </div>
            <p className="text-[#4B5563] text-[16px] leading-[26px] mb-4">
              In the evolving digital economy, competitive advantage increasingly hinges on the quality of transactional experiences. 
              As markets shift towards real-time, personalized engagement, organizations must rethink how value is delivered—not just 
              through products or services, but through every seamless, intelligent, and trust-based interaction.
            </p>
            <p className="text-[#4B5563] text-[16px] leading-[26px] mb-4">
              This whitepaper is part of Volume 1 of the Digital Transformation Management Books (DTMB) and introduces the concept of 
              Perfect Life Transactions as a key differentiator in Economy 4.0. Anchored in the D6 Framework, which defines the path 
              to becoming a Digital Cognitive Organization (DCO), this volume examines the economic logic for transformation.
            </p>
            <p className="text-[#4B5563] text-[16px] leading-[26px] mb-4">
              Drawing on foundational theories such as Transaction Cost Economics and Behavioral Economics, this paper reframes 
              transactions as strategic assets that fuel loyalty, efficiency, and growth.
            </p>
            <p className="text-[#4B5563] text-[16px] leading-[26px]">
              We hope this volume empowers leaders to view digital transactions not as operational steps—but as strategic levers 
          ...
          <section className="mb-12">
            ...
            <p className="text-[#4B5563] text-[16px] leading-[26px] mb-4">
              The future of economic leadership lies in mastering seamless, intelligent, and value-driven transactions. In Economy 4.0, 
              success depends not just on products or services but on orchestrating Perfect Life Transactions; frictionless, 
              hyper-personalized, and adaptive interactions that create both immediate and long-term value.
            </p>
            <p className="text-[#4B5563] text-[16px] leading-[26px] mb-4">
              At the core of this shift is Transaction Cost Economics (TCE), which explains how businesses minimize costs related to 
              search, negotiation, and enforcement (Coase, 1937; Williamson, 1975). With AI, automation, and real-time analytics, 
              businesses boost efficiency, maximize revenue, and drive engagement, turning interactions into continuous value multipliers.
            </p>
            <p className="text-[#4B5563] text-[16px] leading-[26px]">
              DQ's Growth Hack Model structures this evolution, guiding organizations from Market to Lead (M2L) to Revenue to Loyalty (R2L) 
              to refine, optimize, and scale transactions. By integrating DBPs, predictive analytics, and AI-driven automation, businesses 
              shift from reactive processes to continuously evolving, intelligent ecosystems.
            </p>
          </section>
