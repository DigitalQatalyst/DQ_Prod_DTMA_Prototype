    ...
    modules: [
      ...
      },
      {
        ...
        lessons: [
          ...
          {
            id: 'economy-m3-l3',
            title: 'Mastering Customer-Centric Metrics for Success in Economy 4.0',
            duration: '7 min',
            type: 'video',
            videoUrl: '/Mastered in Customer-Centric Metrics for Success in Economy 4.0 (2).mp4',
          },
          {
            id: 'economy-m3-l4',
            title: 'Unveiling Operational Metrics for Excellence in Economy 4.0',
            duration: '6 min',
            type: 'video',
            videoUrl: '/Unveiling operational metrics for excellence in economy 4.0.mp4',
          },
          {
            id: 'economy-m3-l5',
            title: 'Decoding Strategic Imperatives for Future Mastery',
            duration: '7 min',
            type: 'video',
            videoUrl: '/Decoding Strategic Imperatives for Future Mastery.mp4',
          },
          {
            id: 'economy-m3-l6',
