    ...
    <div className="min-h-screen bg-background">
      ...
      <main>
        ...
        <section className="py-16 lg:py-24 bg-[var(--dq-navy-50)]">
          <div className="max-w-[1600px] mx-auto px-8 lg:px-16">
            <div className="text-center mb-12">
              <h2 className="text-[32px] leading-[40px] md:text-[40px] md:leading-[48px] font-semibold text-[var(--dq-navy-950)]">
                Why DTMA?
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
              <div className="p-8 rounded-[12px] bg-white border border-[var(--dq-navy-100)]">
                ...
                <h3 className="text-[20px] leading-[28px] font-semibold text-[var(--dq-navy-950)] mb-3">6XD Framework</h3>
              ...
              <div className="p-8 rounded-[12px] bg-white border border-[var(--dq-navy-100)]">
                ...
                <h3 className="text-[20px] leading-[28px] font-semibold text-[var(--dq-navy-950)] mb-3">Hybrid HI + AI Faculty</h3>
                <p className="text-[14px] leading-[20px] font-normal text-[var(--dq-text-secondary)]">
              ...
              <div className="p-8 rounded-[12px] bg-white border border-[var(--dq-navy-100)]">
                ...
                <h3 className="text-[20px] leading-[28px] font-semibold text-[var(--dq-navy-950)] mb-3">Bite-Sized Learning</h3>
                <p className="text-[14px] leading-[20px] font-normal text-[var(--dq-text-secondary)]">
        ...
        <section className="py-16 lg:py-24 bg-white">
          <div className="max-w-[1600px] mx-auto px-8 lg:px-16">
            <div className="text-center mb-12">
              ...
              <p className="text-[16px] leading-[24px] font-normal text-[var(--dq-text-secondary)] max-w-2xl mx-auto">
            ...
            <div className="grid md:grid-cols-4 gap-6 max-w-5xl mx-auto">
              <div className="text-center">
                ...
                <h3 className="text-[18px] leading-[26px] font-semibold text-[var(--dq-navy-950)] mb-2">Discovery</h3>
                <p className="text-[14px] leading-[20px] font-normal text-[var(--dq-text-secondary)]">Explore the 6XD framework and find your entry point</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-[18px] leading-[26px] font-semibold text-[var(--dq-navy-950)] mb-2">Core Courses</h3>
                <p className="text-[14px] leading-[20px] font-normal text-[var(--dq-text-secondary)]">Complete 7 core 6XD-aligned courses</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-[18px] leading-[26px] font-semibold text-[var(--dq-navy-950)] mb-2">Electives</h3>
                <p className="text-[14px] leading-[20px] font-normal text-[var(--dq-text-secondary)]">Deepen expertise with specialized courses</p>
              </div>
              ...
              <div className="text-center">
                ...
                <h3 className="text-[18px] leading-[26px] font-semibold text-[var(--dq-navy-950)] mb-2">Certification</h3>
                <p className="text-[14px] leading-[20px] font-normal text-[var(--dq-text-secondary)]">Earn KHDA-attested credentials</p>
              </div>
            </div>
          </div>
        </section>
            ...
            <div className="grid md:grid-cols-2 gap-4 max-w-4xl mx-auto">
              {targetAudience.map((audience, index) => (
                ...
                >
                  ...
                  <p className="text-[16px] leading-[24px] font-normal text-[var(--dq-navy-950)]">{audience}</p>
                </div>
              ))}
            </div>
          </div>
        ...
        <section className="py-16 lg:py-24 bg-[var(--dq-navy-950)]">
          <div className="max-w-[1600px] mx-auto px-8 lg:px-16">
            <div className="max-w-3xl mx-auto text-center">
              ...
              <p className="text-[16px] leading-[24px] font-normal text-white/90 mb-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <Link to="/">
                  <button className="px-8 py-3 bg-transparent border border-white text-white hover:bg-white hover:text-[var(--dq-navy-950)] font-semibold rounded-[8px] transition-colors">
                    Learn More
                  </button>
                </Link>
              </div>
