...
type RegistrationStep = "account" | "profile" | "contact" | "payouts";
...
const InstitutionProviderRegistration = () => {
  ...
  const steps: { id: RegistrationStep; label: string; number: number }[] = [
    ...
    { id: "payouts", label: "Payouts", number: 4 },
  ];
  ...
  const validateProfileStep = (): boolean => {
    ...
    if (!formData.tagline.trim()) {
      newErrors.tagline = "Institution tagline is required";
    }
    if (!formData.aboutInstitution.trim()) {
      newErrors.aboutInstitution = "About institution is required";
    }
  ...
  const handleComplete = async () => {
    ...
    try {
      // Create account with institution data
      const result = await registerProvider.mutateAsync({
        firstName: formData.institutionName, // Use institution name as first name
        lastName: "", // Empty for institutions
        email: formData.officialEmail,
        password: formData.password,
        headline: formData.tagline,
        bio: formData.aboutInstitution,
        website: formData.website,
        linkedin: "", // Not applicable for institutions
        providerType: "institution", // CRITICAL: Set as institution
      });
      ...
      // Set institution name for modal
      setInstitutionName(formData.institutionName);
      ...
      toast({
        ...
        description: "Your institution account has been created and is pending verification.",
      });
    } catch (error) {
      toast({
            ...
            <div className="bg-white rounded-2xl border border-border p-8 lg:p-12">
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary ${
                          errors.institutionName ? "border-red-500" : "border-border"
                        }`}
                      />
                    ...
                    <div>
                      ...
                      <select
                        ...
                        onChange={handleInputChange}
                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary ${
                          errors.institutionType ? "border-red-500" : "border-border"
                        }`}
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary ${
                          errors.officialEmail ? "border-red-500" : "border-border"
                        }`}
                        required
                      />
                      {errors.officialEmail && (
                        <p className="text-xs text-red-600 mt-1">{errors.officialEmail}</p>
                      )}
                    </div>
                  ...
                  <div className="space-y-6">
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="Leading university in online education"
                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary ${
                          errors.tagline ? "border-red-500" : "border-border"
                        }`}
                      />
                      {errors.tagline && (
                        <p className="text-xs text-red-600 mt-1">{errors.tagline}</p>
                      )}
                    </div>
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        onChange={handleInputChange}
                        placeholder="Describe your institution, programs, and what makes your courses valuable..."
                        rows={5}
                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary ${
                          errors.aboutInstitution ? "border-red-500" : "border-border"
                        }`}
                      />
                      {errors.aboutInstitution && (
                        <p className="text-xs text-red-600 mt-1">{errors.aboutInstitution}</p>
                      )}
                    </div>
              ...
              {currentStep === "contact" && (
                <div>
                  ...
                  <p className="text-muted-foreground mb-8">
                    Provide contact information for your institution
                  </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="Director of Online Learning"
                        className="w-full px-4 py-2 border border-border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary"
                      />
                    </div>
                  ...
                  <div className="space-y-6">
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-muted-foreground">
                            ...
                            Stripe to connect your bank account.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleInputChange}
                        placeholder="Institution name on bank account"
                        className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-primary ${
                    ...
                    <div>
                      ...
                      {errors.bankRoutingNumber && (
                        <p className="text-xs text-red-600 mt-1">{errors.bankRoutingNumber}</p>
                      )}
                    </div>
                  </div>
                </div>
...
export default InstitutionProviderRegistration;
