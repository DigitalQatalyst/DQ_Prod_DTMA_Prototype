  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl p-8 border border-[#E5E7EB] space-y-8 shadow-md hover:shadow-lg transition-shadow">
        ...
        <div>
          <h3 className="text-[18px] leading-[24px] font-semibold mb-2 text-[#1e2348]">Certificate Branding</h3>
          <p className="text-[14px] leading-[20px] font-normal text-[#4B5563]">Configure how certificates issued by you will appear</p>
        </div>

        {/* Issuing Entity Name */}
        <div>
          <Label className="text-[14px] leading-[20px] font-medium mb-2 block text-[#1e2348]">Issuing Entity Name</Label>
          <Input
            value={certificateSettings.issuingEntityName}
            onChange={(e) => setCertificateSettings({ ...certificateSettings, issuingEntityName: e.target.value })}
            placeholder="Your name or institution name"
            className="focus:ring-[#ff6b4d] focus:ring-opacity-40"
          />
          <p className="text-[13px] leading-[18px] font-normal text-[#4B5563] mt-1.5">This will appear as the issuer on all certificates</p>
        </div>

        {/* Logo Upload */}
        <div>
          <Label className="text-[14px] leading-[20px] font-medium mb-2 block text-[#1e2348]">Logo</Label>
          {certificateSettings.logoPreview ? (
            <div className="flex items-center gap-4">
              <img src={certificateSettings.logoPreview} alt="Logo" className="h-16 w-auto border border-[#E5E7EB] rounded-lg" />
              <Button
                variant="outline"
                size="sm"
                onClick={() => setCertificateSettings({ ...certificateSettings, logo: null, logoPreview: "" })}
                className="border-[#E5E7EB] hover:bg-[#ff6b4d] hover:text-white hover:border-[#ff6b4d]"
              >
                Remove
              </Button>
            </div>
          ) : (
            <div className="border-2 border-dashed border-[#E5E7EB] rounded-xl p-8 text-center hover:border-[#ff6b4d] transition-colors">
              <input
                type="file"
                accept="image/*"
                onChange={handleLogoUpload}
              ...
              <label htmlFor="logo-upload" className="cursor-pointer">
                ...
                <p className="text-[14px] leading-[20px] font-medium text-[#1e2348]">Upload Logo</p>
                <p className="text-[13px] leading-[18px] font-normal text-[#4B5563] mt-1">PNG, JPG up to 2MB</p>
              </label>
            </div>
          )}
        </div>
        ...
        {/* Authorized Signatory Name */}
        <div>
          <Label className="text-[14px] leading-[20px] font-medium mb-2 block text-[#1e2348]">Authorized Signatory Name</Label>
          <Input
            value={certificateSettings.signatoryName}
            onChange={(e) => setCertificateSettings({ ...certificateSettings, signatoryName: e.target.value })}
            placeholder="Name of person authorized to sign certificates"
        ...
        {/* Signature Upload */}
        <div>
          <Label className="text-[14px] leading-[20px] font-medium mb-2 block text-[#1e2348]">Signature</Label>
          {certificateSettings.signaturePreview ? (
            <div className="flex items-center gap-4">
              <img src={certificateSettings.signaturePreview} alt="Signature" className="h-12 w-auto border border-[#E5E7EB] rounded-lg bg-white p-2" />
              <Button
                variant="outline"
                size="sm"
                onClick={() => setCertificateSettings({ ...certificateSettings, signature: null, signaturePreview: "" })}
            ...
            <div className="border-2 border-dashed border-[#E5E7EB] rounded-xl p-8 text-center hover:border-[#ff6b4d] transition-colors">
              ...
              <label htmlFor="signature-upload" className="cursor-pointer">
                <Upload className="w-10 h-10 mx-auto mb-3 text-[#9CA3AF]" />
                <p className="text-[14px] leading-[20px] font-medium text-[#1e2348]">Upload Signature</p>
                <p className="text-[13px] leading-[18px] font-normal text-[#4B5563] mt-1">PNG with transparent background recommended</p>
              </label>
            </div>
          )}
        </div>
        ...
        {/* Accreditation Number */}
        <div>
          <Label className="text-[14px] leading-[20px] font-medium mb-2 block text-[#1e2348]">Accreditation Number (Optional)</Label>
          <Input
            value={certificateSettings.accreditationNumber}
            onChange={(e) => setCertificateSettings({ ...certificateSettings, accreditationNumber: e.target.value })}
            placeholder="e.g., ACC-2024-001"
            className="focus:ring-[#ff6b4d] focus:ring-opacity-40"
          />
          <p className="text-[13px] leading-[18px] font-normal text-[#4B5563] mt-1.5">If your institution has an accreditation number</p>
        </div>

        {/* Footer Text */}
        <div>
          <Label className="text-[14px] leading-[20px] font-medium mb-2 block text-[#1e2348]">Certificate Footer Text</Label>
          <Textarea
            value={certificateSettings.footerText}
            onChange={(e) => setCertificateSettings({ ...certificateSettings, footerText: e.target.value })}
            rows={3}
        ...
        <div className="flex justify-end pt-4 border-t border-[#E5E7EB]">
          <Button onClick={handleSave} className="bg-[#ff6b4d] hover:bg-[#e66045] text-white text-[15px] leading-[22px] font-medium px-6">
            Save Certificate Settings
          </Button>
        </div>
      </div>
