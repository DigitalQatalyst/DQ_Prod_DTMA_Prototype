        ...
        <div className="max-w-[1600px] mx-auto px-8 lg:px-16 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-[#ff6b4d]/10 border border-[#ff6b4d]/20 mb-6">
              <Users className="w-4 h-4 text-[#ff6b4d]" />
              <span className="text-sm font-medium text-[#ff6b4d]">Digital Workers</span>
            </div>
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-4">
              {courses.map((course, index) => (
                ...
                >
                  <div className="w-10 h-10 rounded-full bg-[#ff6b4d] text-white flex items-center justify-center font-semibold flex-shrink-0">
                    {index + 1}
                  </div>
